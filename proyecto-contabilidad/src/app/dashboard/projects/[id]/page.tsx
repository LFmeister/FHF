...
import { Plus, DollarSign, Receipt, Users, Settings, ArrowLeft, BarChart3, PieChart, TrendingUp, FileText } from 'lucide-react'
...
export default function ProjectPage() {
  ...
  // Listen for settings toggle from navigation
  useEffect(() => {
  ...
  // Handle tab changes and reset form states
  const handleTabChange = (tab: string) => {
    if (activeTab === tab) {
      // If clicking the same tab, toggle it off (go back to overview)
